...
export default class GameScene extends Phaser.Scene {
    ...
    preload() {
        this.load_dragonbone("player", "SilverKnight");
        this.load_dragonbone("player2", "GolddenKnight");
        this.load_dragonbone("monsters", "SillyCat");
    ...
    displayPlayers(playerInfo) {
        ...
        var preName = "player";
        if(playerInfo.sprite == "02"){
            preName = "player2"
        }
        const player = this.add.armature("player_" + playerInfo.sprite, preName);
